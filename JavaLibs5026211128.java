class JavaLibs5026211128{
  public static void main (String[] args){
	String name = "Safia Ailsa";
	String nickname = "Fia";
	String hometown = "Bandung";
	int age =19;
	String hobby = "watching movies or dramas";
	String food = "sushi";
	...
	System.out.println("My friends usually call me " +nickname);
	System.out.println("I'm from " +hometown);
	System.out.println("My age is " +age+ " years old");
	System.out.println("My age next year will be " +(++age));
	System.out.println("one of my hobby is " +hobby);
	System.out.println("I love food, but one of my favorite is " +food);
	...
	System.out.println("So, the distance from my kost to Department of Information System is about " +sum1+ " KM");  
